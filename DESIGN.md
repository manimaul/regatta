# Boat (table)
Table of boats (name, sail no, type, rating type, phrf rating, skipper/person, is active)
...
# ORC (table)
Table containing ORC certificate rating information for a particular boat (ref number, boat, cert json).
...
A race class can be associated with multiple Races.
